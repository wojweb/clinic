...
urlpatterns = [
    ...
    path('doctor_appointment/<appointment_id>', views.doctor_appointment, name='doctor_appointment'),
    ...
    path('new_appointment_time/<pesel>', views.receptionist_new_appointment_time, name='new_appointment_time'),
    path('remove_appointment/<appointment_id>', views.receptionist_remove_appointment, name='remove_appointment'),
    path('receptionist_appointment_details/<appointment_id>', views.receptionist_appointment_details, name='receptionist_appointment_details'),
